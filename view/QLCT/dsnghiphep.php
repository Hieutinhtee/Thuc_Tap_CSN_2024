      ...
      <div class="card border-0">
        <div class="card-header">
          ...
          <ul class="nav nav-tabs">
            <li class="nav-item">
              <a class="nav-link active" href="#rejected2" data-bs-toggle="tab">Danh sách đơn nghỉ</a>
            </li>
            <li class="nav-item">
                    ...
                    <div class="card-body">
                      ...
                      <table class="table table-hover text-center">
                        ...
                        <tbody>
                          ...
                          $stmt = $conn->prepare("SELECT * FROM NGHIPHEP WHERE PHEDUYET=0");
                          $stmt->execute();
                          $stt = 0;
                          foreach ($stmt->fetchAll() as $r) {
                            ...
                            <tr>
                              ...
                              <td>
                                <a onclick="return confirm('Xác nhận đồng ý đơn nghỉ của nhân viên <?php echo $r['MANHANVIEN']; ?>. <?php echo $r['TENNV']; ?>');"
                                  href="dongydon.php?xid=<?php echo $r['MANGHIPHEP']; ?>" class="btn btn-success btn-sm">
                                  Đồng ý
                                </a>
                                <a href="tuchoidon.php?xid=<?php echo $r['MANGHIPHEP']; ?>" class="btn btn-danger btn-sm">
                                  Từ chối
                                </a>
                              </td>
